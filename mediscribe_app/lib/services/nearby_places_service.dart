...
class NearbyPlacesService {
  ...
  static Future<List<NearbyPlace>> fetchNearbyPlaces({
    required double lat,
    required double lng,
    int radiusMeters = 10000, // Increased from 5000 to 10000 (10km)
    String? filterType, // 'Hospital', 'Clinic', 'Medical Store', 'Doctor'
  }) async {
    try {
      String query;
      
      print('NearbyPlacesService: Fetching places at lat=$lat, lng=$lng, radius=${radiusMeters}m');
      ...
      print('NearbyPlacesService: Query: $query');
      ...
      print('NearbyPlacesService Error: $e');
      return [];
    }
  }
